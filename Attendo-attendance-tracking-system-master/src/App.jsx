  ...
  return (
    <>
      ...
      <footer className="text-center bg-gray-200 p-4 sm:p-6 lg:p-8">
          <span className="text-black">Updated by Rishika Agarwal</span> <br/>
          <div className="flex justify-center mt-2">
            <a href="https://www.instagram.com/_.rizzy16._/" target='_blank' className="mx-2"><img src={insta} alt="Instagram"/></a>
            <a href="www.linkedin.com/in/rishika-agarwal-072a432a7" target='_blank' className="mx-2"><img src={linkedIn} alt="LinkedIn"/></a>
          </div>
